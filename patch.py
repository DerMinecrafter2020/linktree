...
new_func = """  function initAdminNowPlaying() {
    const player = document.getElementById('admin-np-player');
    const cover = document.getElementById('admin-np-cover');
    const badge = document.getElementById('admin-np-badge');
    const titleEl = document.getElementById('admin-np-title');
    const metaEl = document.getElementById('admin-np-meta');
    const progressEl = document.getElementById('admin-np-progress');
