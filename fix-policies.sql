...
drop policy if exists "profile deny write"  on public.profile;
drop policy if exists "links deny insert"   on public.links;
drop policy if exists "links deny update"   on public.links;
drop policy if exists "links deny delete"   on public.links;
