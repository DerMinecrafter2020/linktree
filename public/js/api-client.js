...
(() => {
  ...
  window.api = {
    ...
    getAdminLinkCategories: () => get('/admin/link-categories'),
    ...
    getMusicAssistantSettings: () => get('/admin/settings/musicassistant'),
    saveMusicAssistantSettings: (cfg) => post('/admin/settings/musicassistant', cfg),
